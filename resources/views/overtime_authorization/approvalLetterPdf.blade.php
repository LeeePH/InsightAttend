...
<head>
    <meta charset="UTF-8">
    <title>Overtime Authorization Form - {{ $requestItem->employee_name }}</title>
    <style>
...
<div class="letter-wrapper">
    ...
    <div class="title">Overtime Authorization Form</div>
    ...
    <table class="grid">
        <thead>
            <tr>
                ...
                <th rowspan="2">TOTAL NUMBER OF OVERTIME HOURS</th>
                <th rowspan="2">REASON FOR OVERTIME</th>
            </tr>
            <tr>
                <th>FROM</th>
                <th>TO</th>
